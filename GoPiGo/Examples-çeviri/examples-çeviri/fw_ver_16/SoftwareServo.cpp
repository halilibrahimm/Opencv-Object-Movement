...
void SoftwareServo::refresh()
{
    ...
    // if we haven't wrapped millis, and 20ms have not passed, then don't do anything// eğer millis sarılmış değilse ve 20ms geçmediyse, hiçbir şey yapma
    ...
    // gather all the SoftwareServos in an array// bir dizi içindeki tüm SoftwareServos'ları topla
