#!/usr/bin/env python
########################################################################                                               
# Bu, PS3 Uzaktankumanda kontrolöründen değerleri okumak için kullanılan kütüphanedir
#                                

import pygame, sys, time ,os
from pygame.locals import *

#PS3 fonksiyonları ve değişkenleri
class ps3:
	joystick=0
	joystick_count=0
	numaxes=0
	...
	#Oject oluşturulduğunda denetleyiciyi başlat
	def __init__(self):
		#Debug ifadelerini yazdırmaya devam eden Pygame hatası nedeniyle stdout tamponunu 0 yapın
